...
public class SysDictData extends BaseEntity
{
    ...
    @NotBlank(message = "Dict labels cannot be empty")
    @Size(min = 0, max = 100, message = "The length of a dict label cannot exceed 100 characters")
    ...
    @NotBlank(message = "The key value of a dict cannot be empty")
    @Size(min = 0, max = 100, message = "The length of dict key values cannot exceed 100 characters")
