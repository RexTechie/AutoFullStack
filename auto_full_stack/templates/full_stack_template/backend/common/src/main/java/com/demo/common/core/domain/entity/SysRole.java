...
public class SysRole extends BaseEntity
{
    ...
    @Excel(name = "Data Scope", readConverterExp = "1=All data permissions,2=Custom data permissions,3=Data permission of this department,4=The data permissions of this department and the following,5=Only personal data permission")
    ...
    @NotBlank(message = "Key characters cannot be empty.")
    @Size(min = 0, max = 100, message = "The length of the key cannot exceed 100 characters")
