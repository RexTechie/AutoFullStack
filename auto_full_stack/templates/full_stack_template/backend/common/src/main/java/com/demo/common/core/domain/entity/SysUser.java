...
import com.demo.common.annotation.Excel.Type;
import com.demo.common.annotation.Excels;
import com.demo.common.core.domain.BaseEntity;
import com.demo.common.xss.Xss;
...
public class SysUser extends BaseEntity
{
    ...
    /** 用户性别 */
    @Excel(name = "Sex", readConverterExp = "0=男,1=女,2=未知")
    private String sex;
    ...
    @Xss(message = "User nicknames cannot contain script characters")
    @Size(min = 0, max = 30, message = "The length of a user nickname cannot exceed 30 characters")
    ...
    @Size(min = 0, max = 11, message = "The length of a mobile phone number cannot exceed 11 characters")
