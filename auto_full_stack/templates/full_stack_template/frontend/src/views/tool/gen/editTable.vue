    ...
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="Field Info" name="columnInfo">
        <el-table ref="dragTable" :data="columns" row-key="columnId" :max-height="tableHeight">
          ...
          <el-table-column label="Column Name" prop="columnName" min-width="10%" :show-overflow-tooltip="true" class-name="allowDrag"/>
          ...
          <el-table-column label="Query Type" min-width="10%">
            <template slot-scope="scope">
          ...
          <el-table-column label="Required" min-width="7%">
            <template slot-scope="scope">
          ...
          <el-table-column label="Display Type" min-width="12%">
            <template slot-scope="scope">
              <el-select v-model="scope.row.htmlType">
                ...
                <el-option label="Date Picker" value="datetime" />
      ...
      <el-tab-pane label="Generation Info" name="genInfo">
...
export default {
  ...
  created() {
    ...
    if (tableId) {
      ...
      /** Query dictionary dropdown list */
      getDictOptionselect().then(response => {
        this.dictOptions = response.data
      })
      /** Query menu dropdown list */
    ...
    submitForm() {
      ...
      Promise.all([basicForm, genForm].map(this.getFormPromise)).then(res => {
        ...
        if (validateResult) {
          ...
          this.$modal.msgError("Form validation failed, please check the submitted content again")
        }
      })
    },
    getFormPromise(form) {
