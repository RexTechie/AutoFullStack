...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure to delete the data item with access ID "' + infoIds + '"?').then(function() {
    ...
    handleUnlock() {
      ...
      this.$modal.confirm('Are you sure to unlock user "' + username + '" data item?').then(function() {
